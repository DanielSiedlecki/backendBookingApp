...
async function loginUser(req: Request, res: Response, next: NextFunction) {
  passport.authenticate('local', { session: true }, (err: Error, user: UserDocument, info: any) => {
    if (err) {
      return next(err);
    }
...
export { createUser, loginUser, forgotPasswordRequest, changePasswordWithToken, checkAuthorization };
